...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aU, request.ac, true);
		} catch (e) {
...
var $author$project$Main$apiBase = '';
						...
						$elm$http$Http$request(
							{
								...
								ac: $author$project$Main$apiBase + ('/api/games/' + ($elm$core$String$fromInt(gid) + '/bets'))
							}));
				} else {
...
var $author$project$Main$ClearError = {$: 8};
...
var $author$project$Main$GoList = {$: 2};
var $author$project$Main$PlaceBet = {$: 6};
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('starts: ' + g.aa)
										])),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
