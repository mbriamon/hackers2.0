...
var $author$project$Main$apiBase = 'http://localhost:8080';
...
var $author$project$Main$gameDecoder = A2(
	...
	function (partial) {
		return A7(
			...
			F6(
				function (hp, ap, dp, ho, ao, d0) {
					return _Utils_update(
						partial,
						{away_odds: ao, away_pool_tokens: ap, draw_odds: d0, draw_pool_tokens: dp, home_odds: ho, home_pool_tokens: hp});
				}),
			...
			A2($elm$json$Json$Decode$field, 'draw_pool_tokens', $elm$json$Json$Decode$int),
			A2($elm$json$Json$Decode$field, 'home_odds', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'away_odds', $elm$json$Json$Decode$float),
			A2($elm$json$Json$Decode$field, 'draw_odds', $elm$json$Json$Decode$float));
	},
	A7(
		$elm$json$Json$Decode$map6,
		F6(
			function (id, sport, home, away, start, status) {
				return {away: away, away_odds: 0, away_pool_tokens: 0, draw_odds: 0, draw_pool_tokens: 0, home: home, home_odds: 0, home_pool_tokens: 0, id: id, sport: sport, start_time: start, status: status};
			}),
		...
		A2($elm$json$Json$Decode$field, 'away', $elm$json$Json$Decode$string),
...
var $author$project$Main$fetchGames = $elm$http$Http$get(
	{
		...
		url: $author$project$Main$apiBase + '/api/games'
	});
var $author$project$Main$ListPage = {$: 'ListPage'};
var $author$project$Main$initModel = {error: $elm$core$Maybe$Nothing, games: _List_Nil, page: $author$project$Main$ListPage, selected: $elm$core$Maybe$Nothing, selection: 'home', stake: '10', userId: 1};
	...
	return $elm$http$Http$get(
		{
			...
			url: $author$project$Main$apiBase + ('/api/games/' + $elm$core$String$fromInt(gid))
		});
};
		...
		switch (msg.$) {
			...
			case 'GoList':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{page: $author$project$Main$ListPage, selected: $elm$core$Maybe$Nothing}),
			...
			case 'GoDetail':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: $author$project$Main$DetailPage(gid),
			...
			case 'SetSelection':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'PlaceBet':
				var _v1 = _Utils_Tuple2(model.page, model.selected);
				if ((_v1.a.$ === 'DetailPage') && (_v1.b.$ === 'Just')) {
					var gid = _v1.a.a;
					var stakeInt = A2(
						$elm$core$Maybe$withDefault,
						0,
						$elm$core$String$toInt(model.stake));
					var body = $elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'user_id',
								$elm$json$Json$Encode$int(model.userId)),
								_Utils_Tuple2(
								'selection',
								$elm$json$Json$Encode$string(model.selection)),
								_Utils_Tuple2(
								'stake',
						...
						$elm$http$Http$request(
							{
								...
								url: $author$project$Main$apiBase + ('/api/games/' + ($elm$core$String$fromInt(gid) + '/bets'))
							}));
				} else {
...
var $author$project$Main$SetSelection = function (a) {
	return {$: 'SetSelection', a: a};
};
var $author$project$Main$SetStake = function (a) {
	return {$: 'SetStake', a: a};
};
...
var $author$project$Main$pct = function (x) {
	var v = $elm$core$Basics$round(x * 1000) / 10;
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(g.sport + (': ' + (g.home + (' vs ' + g.away))))
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$selected(model.selection === 'home')
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$selected(model.selection === 'away')
											]),
										_List_fromArray(
											[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$selected(model.selection === 'draw')
											]),
										_List_fromArray(
											[
...
var $author$project$Main$GoDetail = function (a) {
	return {$: 'GoDetail', a: a};
};
var $elm$html$Html$strong = _VirtualDom_node('strong');
var $author$project$Main$viewList = function (games) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				var _v1 = model.page;
				if (_v1.$ === 'ListPage') {
					return $author$project$Main$viewList(model.games);
				} else {
					var gid = _v1.a;
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2($author$project$Main$initModel, $author$project$Main$fetchGames);
		},
